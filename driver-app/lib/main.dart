...
import 'package:driver_app/features/auth/screens/splash_screen.dart';
...
void main() async {
  ...
  try {
    ...
    if (settings['driverThemeColor'] != null) {
      final hexColor = settings['driverThemeColor'].toString().replaceAll('#', '');
  ...
  runApp(DriverApp(initialPrimaryColor: primaryColor));
}

class DriverApp extends StatelessWidget {
  final Color initialPrimaryColor;
  const DriverApp({super.key, required this.initialPrimaryColor});
          ...
          theme: ThemeData(
            ...
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(
                foregroundColor: initialPrimaryColor,
                textStyle: const TextStyle(
                  fontFamily: 'Cairo',
                  fontWeight: FontWeight.bold,
                ),
